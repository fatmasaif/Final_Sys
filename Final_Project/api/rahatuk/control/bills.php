...
?>
	  ...
	  <h4><?php echo "[Update Order]"; ?></h4>
        ...
        <a  class="close" href='bills.php' >&times;</a>
...
//  echo "<b>ID: <span class='text-white'>[REP".$show_id."]</span></b>";
 ...
 ';
   ...
   <br>
	...
	/* $item_info="SELECT * FROM `orders` WHERE `id` ='$edit_id'";
	 $item_q=mysqli_query($conn,$item_info);
	 $item_data=mysqli_fetch_array($item_q,MYSQLI_ASSOC);
	 */
...
if(empty($_GET['accept'])){
	  ...
	  $all_cart=mysqli_query($conn,"SELECT * FROM `cart` WHERE `order_id` ='$edit_id' and `state` ='Waiting'");
	  ...
	  if($new_state == 'Accepted' ){
       ...
       mysqli_query($conn,"UPDATE `cart` SET `state`='$new_state' WHERE `order_id` ='$edit_id' and `state` ='Waiting'");
	   ...
	   $all_cart=mysqli_query($conn,"SELECT * FROM `cart` WHERE `order_id` ='$edit_id' and `state` ='Accepted'");
	  
	  if($new_state == 'Decline' or $new_state == 'Waiting' ){
	    ...
	    mysqli_query($conn,"UPDATE `cart` SET `state`='$new_state' WHERE `order_id` ='$edit_id'");
	 ...
	 ?>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-outline-dark btn-sm" href='bills.php'>Close</a>
      </div>
    </div>
...
//  echo "<b>ID: <span class='text-white'>[REP".$show_id."]</span></b>";
 ...
 ';
   ...
   <br>
	 ...
	 $all_cart=mysqli_query($conn,"SELECT * FROM `cart` WHERE `id` ='$edit_id' and `state` ='Accepted'");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Waiting Bills</h1>
...
$get_order="SELECT * FROM `orders` WHERE `state` ='Waiting' ORDER BY `id` desc";
...
$show_offer="SELECT * FROM `cart`  where order_id ='$order_id' and state='Waiting'";
    ...
    <thead>
      <tr class="bg-secondary border-white text-white">
	   <th scope="col" class="border-white">Owner</th>
        <th scope="col" class="border-white">Item/Service</th>
