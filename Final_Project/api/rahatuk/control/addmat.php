...
?>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Service <?php if(isset($_GET['of'])){
			echo "From Accepted Offer";	
			} ?></h1>
   ...
   <form action="addmat.php" method="post"  enctype="multipart/form-data">
...
$add_cat="INSERT INTO `services`(`title`, `price`, `descrption`, `cat_id`, `user_id`, `offer_id`) VALUES
 ('$mat_title','$mat_price','$mat_des','$cat_id','$user_id','$offer_id')";
  ...
  <h6>This services is successfully added.</h6>
...
//get data 
$add_cat="INSERT INTO `services`(`title`, `price`, `descrption`, `cat_id`, `user_id`, `offer_id`, `available`, `link`) VALUES
 ('$mat_title','$mat_price','$mat_des','$cat_id','$user_id','$offer_id','$mat_in','$link')";
...
///final 
	...
	<center>
	<div class='alert alert-success'role='alert'>
  <h6>This service is successfully added.</h6>
...
echo "<option value='0' selected>Main Service</option>";


if(empty($offer_num)){
	
//echo "<option>Please add main service.</option>";
...
required><?php echo $_GET['de']; ?></textarea>
</div>
  ...
  <?php 
   ...
   $image_input=' <input type="file" name="files[]" required title="Please select one image." multiple/>';
...
<center><h4 class="bg-light">[Pictures]</h4></center>
 ...
 <hr>
   ...
   <button type="submit" class="btn btn-success rounded-pill border-white" name="<?php echo"$name_action";?>" >Add Service</button>
