      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Accepted Offers</h1>
...
if(isset($_GET['show'])){
	...
	$show_res=mysqli_query($conn,"SELECT * FROM `offers` WHERE `state` = 'accept'");
	$showvalue=mysqli_fetch_array($show_res);
	$offer_title_is=$showvalue['title'];
...
$show_offer="SELECT * FROM `offers` WHERE `state` ='accept' ORDER BY id DESC";
...
if(empty($offer_num)){
	...
	echo 
	"<br><center><h4>No accept offers has been found.</h4></center>";
...
$add_mat_url="addmat.php?of=$trans_id&de=$de&pr=$pr&ti=$ti&u=$user_id";


//&de=$row['description']&pr=$row['price']&ti=$row['title']&u=$user_id";
   ...
   // $date = $row['date'];
	...
	<td class='bg-warning text-white'>OFFER-".$row['id']."</td>
		...
		<td class='bg-danger'><a  class='text-white' href='?show=".$row['id']."'><b>Preview</b></a>| <br> <a class='text-drak bg-white' target='_blank' href='".$add_mat_url."'><b>Add To Materials</b></a></td>
