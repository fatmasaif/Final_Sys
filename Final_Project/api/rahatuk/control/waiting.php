      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Waiting Offers</h1>
...
$show_offer="SELECT * FROM `offers` WHERE `state` ='Waiting' ORDER BY id DESC";
...
if(empty($offer_num)){
	...
	echo 
	"<br><center><h4>No waiting offers has been found.</h4></center>";
